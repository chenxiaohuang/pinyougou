...
public class SellerServiceImpl implements SellerService {
	...
	public void updateStatus(String sellerId, String status) {
		TbSeller seller = sellerMapper.selectByPrimaryKey(sellerId);//根据id查询所有商家
		seller.setStatus(status);//添加状态，但是没有添加到数据库表中
		sellerMapper.updateByPrimaryKey(seller);//添加到表中，更新表
	}
}
